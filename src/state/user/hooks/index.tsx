...
export function useGasPrice(): string {
  ...
  return chainId === ChainId.CORE.toString() ? userGas : GAS_PRICE_GWEI.testnet
}
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Rice-LP', 'Riceswap LPs')
}
